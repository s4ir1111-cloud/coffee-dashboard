...
def main():
    ...
    ready={"generated_at":raw["generated_at"],"period":raw["period"],"sales_checks":checks,"guest_frequency":src.get("guest_frequency",{}).get("summary",{}),"guest_trends":src.get("guest_trends",{}).get("summary",{}).get("periods",[]),"menu_sku":menu,"purchases":purchase_rows,"raw_material":usage_rows,"sales_by_hour":src["sales_by_hour"]["rows"]}
